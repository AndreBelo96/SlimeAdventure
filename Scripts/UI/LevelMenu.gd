...
var LevelLoader = preload("res://Scripts/Levels/LevelLoader.gd")
var LevelButtonFactory = preload("res://Scripts/Levels/LevelButtonFactory.gd")

var loader: LevelLoader
var factory: LevelButtonFactory
